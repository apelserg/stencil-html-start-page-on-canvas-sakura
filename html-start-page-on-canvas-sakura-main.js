...
APELSERG.CONFIG.SET.PicSrc = ["sakura.jpg"]; //-- заставка канвы
...
APELSERG.CONFIG.SET.SakuraNum = 1000; //-- число
APELSERG.CONFIG.SET.SakuraSize = 10; //-- максимальный размер
...
APELSERG.MAIN.OnLoad = function () {
    ...
    APELSERG.CONFIG.PROC.Img.onload = function () {
        ...
        APELSERG.MODEL.DATA.Sakura = APELSERG.MODEL.MakeSakura(APELSERG.CONFIG.SET.SakuraNum);
...
APELSERG.MAIN.Animation = function () {
    ...
    if (APELSERG.CONFIG.PROC.CntHandle == 1) APELSERG.MODEL.UpdateSakura();
